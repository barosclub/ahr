...
/**
 * Death_hosxpSearch represents the model behind the search form about `common\models\death_hosxp`.
 */
class Death_hosxpSearch extends death_hosxp
{
    /**
     * @inheritdoc
     */
